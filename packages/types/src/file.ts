...
export type TAssetSelection =
  | { kind: "empty" }
  | { kind: "persisted"; asset: IAssetReference }
  | { kind: "pending"; asset: IFileUploadResult; previous: IAssetReference | null }
  | { kind: "removed"; previous: IAssetReference }
  | { kind: "failed"; asset: IFileUploadResult | null; previous: IAssetReference | null; message: string };
