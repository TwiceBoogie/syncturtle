...
import com.syncturtle.services.instance.configurations.telemetry.ProductTelemetrySdkConfig.ProductTelemetrySdk;
...
public class ProductTelemetryReporter {
    ...
    public void emitSnapshot() {
        Instance instance = instanceRepository.findFirstByDeletedAtIsNullOrderByCreatedAtDesc().orElse(null);
