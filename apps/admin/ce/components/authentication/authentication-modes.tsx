...
interface IAuthenticationModeProps {
  disabled: boolean;
...
export const getAuthenticationModes: (props: TGetBaseAuthenticationModeProps) => TInstanceAuthenticationModes[] = ({
...
}) => [
  {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for Syncturtle using codes sent via email. You need to have setup SMTP to use this feature.",
  ...
  },
  {
    key: "gitlab",
    name: "GitLab",
    description: "Allow members to log in or sign up to Syncturtle with their GitLab accounts.",
