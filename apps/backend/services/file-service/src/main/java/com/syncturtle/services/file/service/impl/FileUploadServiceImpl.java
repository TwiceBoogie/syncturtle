...
import com.syncturtle.services.file.service.asset.FileAssetObjectKeyFactory;
...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    private FileUploadCreateResponse createUploadWithoutIdempotency(UUID currentUserId,
        ...
        PresignedPostData uploadData = storage.generatePresignedPost(
                saved.getObjectKey(),
    ...
    private FileUploadCreateResponse replayOrReject(IdempotencyRecord existing, String requestHash) {
        ...
        try {
            return objectMapper.readValue(existing.getResponseBody(), FileUploadCreateResponse.class);
