...
// public static <T> CursorPageResponse<T> pageWithNext(List<T> results, int
// perPage, String nextCursor) {
...
// public static <T> CursorPageResponse<T> pageWithPrev(List<T> results, int
// perPage, String prevCursor) {
// CursorPageResponse<T> response = page(results, perPage);
