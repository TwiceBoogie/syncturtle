// package com.syncturtle.services.workspace.unit.web;
...
// import
// com.syncturtle.services.workspace.application.query.WorkspaceQueryHandler;
// import
// com.syncturtle.services.workspace.controller.client.WorkspaceAdminController;
// import com.syncturtle.services.workspace.dto.response.WorkspaceResponse;
// import
// com.syncturtle.services.workspace.testsupport.factories.CursorPageResponseFactory;
// import
// com.syncturtle.services.workspace.testsupport.factories.WorkspaceResponseFactory;
...
// WorkspaceResponse r2 = WorkspaceResponseFactory.aWorkspace(UUID.randomUUID(),
// "Capsule Corp",
// "capsule-corp");
// when(query.workspaceAll(anyString(), anyInt(), anyString()))
// .thenReturn(CursorPageResponseFactory.pageWithNext(List.of(r1, r2), 5,
// "createdBy123"));
// // act + assert
...
// ArgumentCaptor<Integer> perPageCaptor =
// ArgumentCaptor.forClass(Integer.class);
// ArgumentCaptor<String> searchCaptor = ArgumentCaptor.forClass(String.class);
// // verify
// verify(query).workspaceAll(cursorCaptor.capture(), perPageCaptor.capture(),
