...
public class OutboxKafkaPublisher {
    ...
    public void publishWorkspaceOutboxEvent(String topic, String messageKey, WorkspaceOutboxEvent event) {
        ...
        try {
            ...
            log.info("Published workspace outbox event. topic={} key={} eventType={} partition={} offset={}",
    ...
    private static IllegalStateException publishFailed(String topic, String messageKey, WorkspaceOutboxEvent event,
            Exception exception) {
