...
--changeset syncturtle:0005-001-add-outbox-messages labels:workspace
...
--changeset syncturtle:0005-020-index-outbox-messages-due labels:workspace
...
--changeset syncturtle:0005-021-index-outbox-messages-aggregate labels:workspace
...
--changeset syncturtle:0001-022-index-outbox-messages-locked labels:workspace
