...
@FeignClient(value = ServiceClientNames.INSTANCE_SERVICE, contextId = "emailInstanceClient", url = "${app.clients.instance-service.base-url}", path = "/internal/v1/instances", configuration = InstanceServiceFeignConfiguration.class)
