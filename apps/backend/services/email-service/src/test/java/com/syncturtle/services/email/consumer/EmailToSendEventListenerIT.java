...
// import
// com.syncturtle.services.email.integration.support.EmailKafkaTopicsTestConfiguration;
...
// ArgumentCaptor<EmailEnvelope> envelopeCaptor =
// ArgumentCaptor.forClass(EmailEnvelope.class);
...
// assertThat(sentEnvelope.getModel()).containsEntry("magicLink",
// "https://app.syncturtle.com/magic?token=abc");
...
// @Test
// void
// onEmailToSend_whenDuplicateArrivesWhileFirstIsStillProcessing_doesNotDispatchTwice()
// throws Exception {
// // arrange
// String eventId = UUID.randomUUID().toString();
// EmailToSendEvent event = event(eventId);
...
// @Test
// void
// onEmailToSend_whenSameEventPublishedAgainAfterSent_doesNotCreateNewRowOrDispatchAgain()
// {
// // arrange
// String eventId = UUID.randomUUID().toString();
// EmailToSendEvent event = event(eventId);
...
// @Test
// void
// onEmailSend_whenDispatchFailsRetryably_marksFailedRetryableAndSchedulesNextAttempt()
// {
// // arrange
// String eventId = UUID.randomUUID().toString();
// EmailToSendEvent event = event(eventId);
...
// String eventId = UUID.randomUUID().toString();
// EmailToSendEvent event = event(eventId);
// RuntimeException thrown = new IllegalArgumentException("template missing
// variable");
...
// @Test
// void
// onEmailToSend_whenExistingProcessingLeaseExpired_requiresRowAndProcessingAgain()
// {
// // arrange
// String eventId = UUID.randomUUID().toString();
// saveInboxRow(
...
// @Test
// void
// onEmailToSend_whenExistingRowIsPermanentFailure_skipsDuplicateWithoutDispatch()
// {
// // arrange
// String eventId = UUID.randomUUID().toString();
// saveInboxRow(
...
// @Disabled("Enable after EmailEventInboxService.tryAcquire() returns
// RETRY_SCHEDULED for FAILED_RETRYABLE rows whose nextAttemptAt is still in the
// future.")
// @Test
// void
// onEmailToSend_whenExistingRowIsRetryableButNotYetDue_skipsDuplicateUntilDue()
// {
// // arrange
// String eventId = UUID.randomUUID().toString();
// saveInboxRow(
...
// private EmailEventInbox awaitRowWithStatus(String eventId,
// EmailEventInboxStatus status) {
// await().atMost(Duration.ofSeconds(10)).untilAsserted(() -> {
// EmailEventInbox row = findRowOrThrow(eventId);
...
// return findRow(eventId).orElseThrow(() -> new AssertionError("Row not found
// for eventId=" + eventId));
// }
