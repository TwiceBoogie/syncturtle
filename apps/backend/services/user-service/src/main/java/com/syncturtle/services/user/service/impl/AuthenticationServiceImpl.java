...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private final MagicLinkEmailEventFactory emailEventFactory;
    ...
    public MagicCodeResponse generateMagicCode(String email) {
        ...
        EmailToSendEvent event = emailEventFactory.magicLink(email, challenge.getToken(), challenge.getExpiresIn());
