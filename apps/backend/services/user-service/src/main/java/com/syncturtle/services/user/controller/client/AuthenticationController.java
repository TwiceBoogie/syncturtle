...
public class AuthenticationController {
    ...
    public ResponseEntity<Void> signin(
        ...
        Optional<AuthException> validationFailure = authFormValidator.validate(AuthFlow.REGULAR_SIGN_IN, bindingResult,
        ...
        IssueTokenResponse response = authenticationService.emailPasswordSignIn(request.getEmail(),
                request.getPassword(), request.getNextPath());
    ...
    public ResponseEntity<Void> signup(
            ...
            BindingResult bindingResult,
            HttpServletResponse servletResponse) {
        Optional<AuthException> validationFailure = authFormValidator.validate(AuthFlow.REGULAR_SIGN_UP, bindingResult,
        ...
        IssueTokenResponse response = authenticationService.emailPasswordSignUp(request.getEmail(),
                request.getPassword(), request.getNextPath());
