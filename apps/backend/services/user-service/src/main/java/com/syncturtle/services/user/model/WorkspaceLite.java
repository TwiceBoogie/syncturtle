...
public class WorkspaceLite {
    ...
    public static WorkspaceLite fromReplicaParam(WorkspaceLiteReplicaParam param, Clock clock) {
        Assert.notNull(param, "workspace lite replica param is required");
    ...
    public boolean applyReplicaParam(WorkspaceLiteReplicaParam param, Clock clock) {
        Assert.notNull(param, "workspace lite replica param is required");
        Assert.notNull(clock, "clock is required");
    ...
    private void requireSameWorkspaceOrUninitialized(WorkspaceLiteReplicaParam param) {
        if (id == null) {
            return;
        }

        Assert.isTrue(id.equals(param.getId()), "cannot apply replica data for a different workspace");
    }
