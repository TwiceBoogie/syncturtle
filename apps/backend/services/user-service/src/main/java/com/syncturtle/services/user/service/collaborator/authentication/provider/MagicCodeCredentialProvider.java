...
import com.syncturtle.services.user.service.collaborator.authentication.magic.MagicCodeStore;
...
public class MagicCodeCredentialProvider implements CredentialProvider {
    ...
    private void requireRequestedFlowMatchesUserState(CredentialAuthenticationParam param, String email,
    ...
    private void requireSubmittedCode(CredentialAuthenticationParam param) {
