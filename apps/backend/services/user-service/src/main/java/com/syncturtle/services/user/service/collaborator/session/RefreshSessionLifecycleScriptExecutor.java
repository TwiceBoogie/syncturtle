...
public final class RefreshSessionLifecycleScriptExecutor {

    public static final String SCRIPT_PATH = "redis/refresh-session-lifecycle.lua";

    private final StringRedisTemplate redis;
    @SuppressWarnings("rawtypes")
    private final RedisScript<List> script;

    public RefreshSessionLifecycleScriptExecutor(StringRedisTemplate redis) {
    ...
    public List<String> execute(List<String> keys, List<String> arguments) {
        ...
        if (result == null || result.isEmpty()) {
            throw new IllegalStateException("refresh session lifecycle script returned no result");
        }
