...
import com.syncturtle.services.user.messaging.kafka.mapper.WorkspaceMemberEventMapper;
...
import com.syncturtle.services.user.repository.WorkspaceMemberRepository;
...
public class KafkaWorkspaceMemberEventConsumer {
    ...
    @Transactional
    @KafkaListener(topics = KafkaTopics.WORKSPACE_MEMBER_EVENTS_V1, groupId = "user-svc-workspace-member-event-v1", containerFactory = "workspaceMemberKafkaListenerFactory")
    public void onWorkspaceMember(WorkspaceMemberEvent event) {
