...
import com.syncturtle.services.user.configuration.passport.KeyMaterial;
...
public class AccessTokenIssuer {
    ...
    public IssuedAccessTokenReceipt issueAccessToken(AccessTokenIssueParam spec) {
        validate(spec);
    ...
    private void validate(AccessTokenIssueParam spec) {
