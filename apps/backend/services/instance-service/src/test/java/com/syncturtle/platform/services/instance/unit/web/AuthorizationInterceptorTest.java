...
import com.syncturtle.platform.services.instance.configurations.web.AuthorizationInterceptor;
import com.syncturtle.platform.services.instance.services.authz.InstanceAuthorizationService;
...
public class AuthorizationInterceptorTest {
    ...
    void allowAnonymous_shouldPass() throws Exception {
        ...
        // conditions
        // act
        boolean allowed = interceptor.preHandle(request, response, handler(new DemoController(), "anon"));
        // assertions
