...
import com.syncturtle.services.instance.messaging.kafka.publisher.OutboxKafkaPublisher;
import com.syncturtle.services.instance.messaging.outbox.OutboxEnvelope;
import com.syncturtle.services.instance.messaging.outbox.OutboxEventDeserializer;
import com.syncturtle.services.instance.service.OutboxRelayService;
import com.syncturtle.services.instance.service.collaborator.outbox.OutboxMessageClaimer;
import com.syncturtle.services.instance.service.collaborator.outbox.OutboxMessageRecorder;
import com.syncturtle.services.instance.service.collaborator.outbox.OutboxRetryDelayPolicy;
...
public class OutboxRelayServiceImpl implements OutboxRelayService {
    ...
    private void publishOne(OutboxEnvelope envelope) {
        ...
        try {
            ...
            recorder.markFailed(envelope.getId(), exceptionMessage(exception), retryDelay);
