...
public class UserLite {
    ...
    public static UserLite fromReplicaParam(UserReplicaParam param, Clock clock) {
    ...
    public boolean applyReplicaParam(UserReplicaParam param, Clock clock) {
        ...
        changed |= setLastLoginMedium(param.getLastLoginMedium());
        ...
        changed |= setPrincipal(param.getPrincipalType());
    ...
    private boolean setLastLoginMedium(String lastLoginMedium) {
        if (Objects.equals(this.lastLoginMedium, lastLoginMedium)) {
            return false;
        }

        this.lastLoginMedium = lastLoginMedium;
        return true;
    }
    ...
    private boolean setPrincipal(PrincipalType principalType) {
