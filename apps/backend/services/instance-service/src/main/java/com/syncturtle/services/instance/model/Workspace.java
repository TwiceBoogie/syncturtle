...
public class Workspace {
    ...
    public static Workspace fromReplicaParam(WorkspaceReplicaParam param, Clock clock) {
    ...
    public boolean applyReplicaParam(WorkspaceReplicaParam param, Clock clock) {
        ...
        if (param.isStaleComparedTo(version)) {
            return false;
        }
        ...
        changed |= setTotalMembers(param.getTotalMembers());
    ...
    private boolean setSourceVersion(Long version) {
    ...
    private boolean setTotalMembers(long totalMembers) {
        if (this.totalMembers == totalMembers) {
            return false;
        }
