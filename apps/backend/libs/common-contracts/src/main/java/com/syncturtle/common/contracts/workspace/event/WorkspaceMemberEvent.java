...
@Getter
public final class WorkspaceMemberEvent implements WorkspaceOutboxEvent {

    public enum Type {
        WORKSPACE_MEMBER_CREATED,
        WORKSPACE_MEMBER_UPDATED,
        WORKSPACE_MEMBER_SOFT_DELETE
    }
    ...
    public boolean isCreateEvent() {
        return type == Type.WORKSPACE_MEMBER_CREATED;
    }

    @Override
    public boolean isUpdateEvent() {
        return type == Type.WORKSPACE_MEMBER_UPDATED;
    }

    @Override
    public boolean isDeleteEvent() {
        return type == Type.WORKSPACE_MEMBER_SOFT_DELETE;
    }
