...
import com.syncturtle.common.web.error.ServletGlobalExceptionHandler;
...
@ConditionalOnClass({
        ...
        ServletGlobalExceptionHandler.class,
...
public class ServletErrorHandlingAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    ServletGlobalExceptionHandler servletGlobalExceptionHandler(ApiErrorResponseFactory responseFactory) {
