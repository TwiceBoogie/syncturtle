...
export type TRedirectAuthState = {
  authModeOverride: EAuthModes;
  authStep: EAuthSteps;
  errorInfo?: TAuthErrorInfo;
};
...
export const getRedirectAuthState = (
  ...
  const defaultState: TRedirectAuthState = {
    authModeOverride: currentAuthMode,
    authStep: EAuthSteps.EMAIL,
  };

  const errorInfo = authErrorHandler(errorCode ?? undefined, emailParam);
  ...
  switch (errorInfo.code) {
    case EAuthenticationErrorCodes.AUTHENTICATION_FAILED_SIGN_UP:
      return {
        authModeOverride: EAuthModes.SIGN_UP,
        authStep: EAuthSteps.PASSWORD,
        errorInfo,
      };
    case EAuthenticationErrorCodes.AUTHENTICATION_FAILED_SIGN_IN:
      return {
        authModeOverride: EAuthModes.SIGN_IN,
        authStep: EAuthSteps.PASSWORD,
        errorInfo,
      };
    case EAuthenticationErrorCodes.INVALID_MAGIC_CODE_SIGN_UP:
    case EAuthenticationErrorCodes.INVALID_EMAIL_MAGIC_SIGN_UP:
    case EAuthenticationErrorCodes.EXPIRED_MAGIC_CODE_SIGN_UP:
      return {
        authModeOverride: EAuthModes.SIGN_UP,
        authStep: EAuthSteps.UNIQUE_CODE,
        errorInfo,
      };
    case EAuthenticationErrorCodes.INVALID_MAGIC_CODE_SIGN_IN:
    case EAuthenticationErrorCodes.INVALID_EMAIL_MAGIC_SIGN_IN:
    case EAuthenticationErrorCodes.EXPIRED_MAGIC_CODE_SIGN_IN:
      return {
        authModeOverride: EAuthModes.SIGN_IN,
        authStep: EAuthSteps.UNIQUE_CODE,
        errorInfo,
